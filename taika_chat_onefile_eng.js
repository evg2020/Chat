...
.taika-agent-message {
  letter-spacing: 0;
   ...
   border-color:  #EDF9FF white white white;
...
.taika-user-message {
  letter-spacing: 0;
   ...
   border-color:  #EFEEEC white white white;
   color: #EFEEEC;
...
/* page 1*/
.taika-chat-page-greeting {
  padding-top: 10%;
}
.taika-chat-page1 { /*while there old style chat scripts*/
  padding-top: 20%;
}
...
div.taika-chat-username {
  padding-left: 25px;
  margin-top: 30px;
}

div.taika-chat-questions {
  padding-left: 25px;
  margin-top: 30px;
  overflow-y: auto;
  /*height: 240px;*/
...
.taika-file-info-panel{
  float:left;
  padding-left: 2px;
}
.taika-chat-menu:hover, .taika-chat-menu:focus {
...
.taika-chat-title.taika-no-logo {
  height: 40px;
  display: table-cell;
  margin-left:10px;
}
...
.padded_placeholder::-webkit-input-placeholder {text-align: center; vertical-align: middle}
.padded_placeholder:-moz-placeholder { /* Firefox 18- */text-align: center; vertical-align: middle}
.padded_placeholder::-moz-placeholder {  /* Firefox 19+ */text-align: center; vertical-align: middle}
.padded_placeholder:-ms-input-placeholder {text-align: center; vertical-align: middle}

/* Dropdown Content (Hidden by Default) */
.taika-chat-menu-list {
  display: none;
  position: absolute;
...
.taika-chat-menu-list a:hover {background-color: #ddd}
...
@media print {
  .taika-agent-message  {width: 100%;}
  .taika-agent-message > .message {width:100%}

  .taika-user-message   {width: 100%;}
  .taika-user-message > .message {width:100%}

  .taika-message-time {vertical-align: top}
}
...
.taika-joy-thumb-up > i:hover {
  color: darkgreen;
  transform: scale(1.5) !important;
}

.taika-joy-thumb-down {
  position: relative;
  top: 7px;
  margin: 5px 5px 5px 5px;
}

.taika-joy-thumb-down > i {
  transform: scale(-1, 1)
}

.taika-joy-thumb-down > i:hover {
  color: red;
...
.taika-joy-mark{
 ...
 `
var styleChatPreview = document.createElement("style")
styleChatPreview.innerHTML = chatPreview
document.head.appendChild(styleChatPreview)



//taika_test_style.css

var testStyle = `
/* ESECOM grey #303030 */
/* ESECOM orange #FF9900 */
...
.wcs-action-icon:hover, .wcs-action-icon:focus {
  background-color: #F2F2F2;
}
.wcs-action-icon-rev {
  height: 10;
...
.wcs-action-icon-rev:hover, .wcs-action-icon-rev:focus,
.taika-action-icon-rev:hover, .taika-action-icon-rev:focus{
...
#wcs-send-button:hover, #wcs-send-button:focus {
  background-color: #007095;
  color: white;
}
...
`
var styleTastStyle = document.createElement("style")
styleTastStyle.innerHTML = testStyle
document.head.appendChild(styleTastStyle)
    ...
    $.fn.printThis = function (options) {
        ...
        setTimeout(function () {
            ...
            // otherwise just print interior elements of container
                ...
                //$body.append("Chat-Sessio ID: "+sessionId+"<hr>"+$(this).html());
